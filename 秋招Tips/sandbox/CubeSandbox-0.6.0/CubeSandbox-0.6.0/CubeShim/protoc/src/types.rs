...
impl ::protobuf::Message for IPAddress {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        if self.family != IPFamily::v4 {
            os.write_enum(1, ::protobuf::ProtobufEnum::value(&self.family))?;
        }
        if !self.address.is_empty() {
    ...
    fn default_instance() -> &'static IPAddress {
        static instance: ::protobuf::rt::LazyV2<IPAddress> = ::protobuf::rt::LazyV2::INIT;
...
impl ::protobuf::Message for Interface {
    ...
    fn default_instance() -> &'static Interface {
        static instance: ::protobuf::rt::LazyV2<Interface> = ::protobuf::rt::LazyV2::INIT;
...
impl Route {
    ...
    pub fn get_onlink(&self) -> bool {
        self.onlink
    }
    pub fn clear_onlink(&mut self) {
        self.onlink = false;
    }

    // Param is passed by value, moved
    pub fn set_onlink(&mut self, v: bool) {
        self.onlink = v;
    }
}
...
impl ::protobuf::Message for Route {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                6 => {
                    ::protobuf::rt::read_proto3_enum_with_unknown_fields_into(wire_type, is, &mut self.family, 6, &mut self.unknown_fields)?
                },
                7 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.family != IPFamily::v4 {
            my_size += ::protobuf::rt::enum_size(6, self.family);
        }
        if self.onlink != false {
            my_size += 2;
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.family != IPFamily::v4 {
            os.write_enum(6, ::protobuf::ProtobufEnum::value(&self.family))?;
        }
        if self.onlink != false {
            os.write_bool(7, self.onlink)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
...
impl ::protobuf::Message for ARPNeighbor {
    ...
    fn default_instance() -> &'static ARPNeighbor {
        static instance: ::protobuf::rt::LazyV2<ARPNeighbor> = ::protobuf::rt::LazyV2::INIT;
...
impl ::protobuf::ProtobufEnum for FSGroupChangePolicy {
    fn value(&self) -> i32 {
        *self as i32
    }
    ...
    fn values() -> &'static [Self] {
        static values: &'static [FSGroupChangePolicy] = &[
    ...
    fn enum_descriptor_static() -> &'static ::protobuf::reflect::EnumDescriptor {
        static descriptor: ::protobuf::rt::LazyV2<::protobuf::reflect::EnumDescriptor> = ::protobuf::rt::LazyV2::INIT;
        descriptor.get(|| {
            ::protobuf::reflect::EnumDescriptor::new_pb_name::<FSGroupChangePolicy>("FSGroupChangePolicy", file_descriptor_proto())
        })
    }
}

impl ::std::marker::Copy for FSGroupChangePolicy {
}
...
impl ::protobuf::reflect::ProtobufValue for FSGroupChangePolicy {
    fn as_ref(&self) -> ::protobuf::reflect::ReflectValueRef {
        ::protobuf::reflect::ReflectValueRef::Enum(::protobuf::ProtobufEnum::descriptor(self))
    }
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x0btypes.proto\x12\x05types\"j\n\tIPAddress\x12)\n\x06family\x18\x01\
    \x20\x01(\x0e2\x0f.types.IPFamilyR\x06familyB\0\x12\x1a\n\x07address\x18\
    \x02\x20\x01(\tR\x07addressB\0\x12\x14\n\x04mask\x18\x03\x20\x01(\tR\x04\
    maskB\0:\0\"\xf2\x01\n\tInterface\x12\x18\n\x06device\x18\x01\x20\x01(\t\
    R\x06deviceB\0\x12\x14\n\x04name\x18\x02\x20\x01(\tR\x04nameB\0\x124\n\
    \x0bIPAddresses\x18\x03\x20\x03(\x0b2\x10.types.IPAddressR\x0bIPAddresse\
    sB\0\x12\x12\n\x03mtu\x18\x04\x20\x01(\x04R\x03mtuB\0\x12\x18\n\x06hwAdd\
    r\x18\x05\x20\x01(\tR\x06hwAddrB\0\x12\x1a\n\x07pciPath\x18\x06\x20\x01(\
    \tR\x07pciPathB\0\x12\x14\n\x04type\x18\x07\x20\x01(\tR\x04typeB\0\x12\
    \x1d\n\traw_flags\x18\x08\x20\x01(\rR\x08rawFlagsB\0:\0\"\xcc\x01\n\x05R\
    oute\x12\x14\n\x04dest\x18\x01\x20\x01(\tR\x04destB\0\x12\x1a\n\x07gatew\
    ay\x18\x02\x20\x01(\tR\x07gatewayB\0\x12\x18\n\x06device\x18\x03\x20\x01\
    (\tR\x06deviceB\0\x12\x18\n\x06source\x18\x04\x20\x01(\tR\x06sourceB\0\
    \x12\x16\n\x05scope\x18\x05\x20\x01(\rR\x05scopeB\0\x12)\n\x06family\x18\
    \x06\x20\x01(\x0e2\x0f.types.IPFamilyR\x06familyB\0\x12\x18\n\x06onlink\
    \x18\x07\x20\x01(\x08R\x06onlinkB\0:\0\"\xa9\x01\n\x0bARPNeighbor\x124\n\
    \x0btoIPAddress\x18\x01\x20\x01(\x0b2\x10.types.IPAddressR\x0btoIPAddres\
    sB\0\x12\x18\n\x06device\x18\x02\x20\x01(\tR\x06deviceB\0\x12\x18\n\x06l\
    laddr\x18\x03\x20\x01(\tR\x06lladdrB\0\x12\x16\n\x05state\x18\x04\x20\
    \x01(\x05R\x05stateB\0\x12\x16\n\x05flags\x18\x05\x20\x01(\x05R\x05flags\
    B\0:\0*\x1c\n\x08IPFamily\x12\x06\n\x02v4\x10\0\x12\x06\n\x02v6\x10\x01\
    \x1a\0*7\n\x13FSGroupChangePolicy\x12\n\n\x06Always\x10\0\x12\x12\n\x0eO\
    nRootMismatch\x10\x01\x1a\0B\0b\x06proto3\
";
