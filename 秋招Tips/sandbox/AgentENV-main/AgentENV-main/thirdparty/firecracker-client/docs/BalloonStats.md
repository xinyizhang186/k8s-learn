...
**oom_kill** | Option<**i64**> | OOM killer invocations, indicating critical memory pressure. | [optional]
**alloc_stall** | Option<**i64**> | Counter of Allocation enter a slow path to gain more memory page. The reclaim/scan metrics can reveal what is actually happening. | [optional]
**async_scan** | Option<**i64**> | Amount of memory scanned asynchronously. | [optional]
**direct_scan** | Option<**i64**> | Amount of memory scanned directly. | [optional]
**async_reclaim** | Option<**i64**> | Amount of memory reclaimed asynchronously. | [optional]
**direct_reclaim** | Option<**i64**> | Amount of memory reclaimed directly. | [optional]
