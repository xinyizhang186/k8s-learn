...
pub struct StartFreshHookResponse {
    /// Extra kernel boot args appended to the sandbox boot args.
    #[serde(
        rename = "extraBootArgs",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub extra_boot_args: Option<Option<String>>,
}

impl StartFreshHookResponse {
    pub fn new() -> StartFreshHookResponse {
